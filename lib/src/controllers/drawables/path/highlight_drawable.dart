...
/// Highlight Drawable (hand scribble highlighting).
class HighlightDrawable extends PathDrawable {
  /// The color the path will be drawn with.
  final Color color;

  /// Creates a [HighlightDrawable] to draw [path].
  ///
  ...
  //
  // @override
  // int get hashCode => hashValues(hidden, hashList(path), color, strokeWHighlight
}
